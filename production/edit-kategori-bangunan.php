...
$query = "SELECT * FROM tb_kategori_bangunan WHERE id_kategori_bangunan=$id";
...
<head>
  ...
  <title>Edit Kategori Bangunan</title>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $query = "UPDATE tb_kategori_bangunan SET deskripsi='$kategori' where id_kategori_bangunan='".$row['id_kategori_bangunan']."'";
