...
<head>
  ...
  <title>Tambah Kategori Freelance</title>
        ...
        <div class="">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Tambah Kategori Freelance</h2>
                ...
                <div class="x_content">
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $query = "INSERT INTO tb_kategori_freelance (id_kategori_freelance, deskripsi) VALUES (NULL, '$kategori')";
