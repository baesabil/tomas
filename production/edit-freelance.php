...
$query = "SELECT * FROM tb_freelance WHERE id_freelance=$id";
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="select2_single form-control col-md-7 col-xs-12" required="required" name="kategori">
                                                    ...
                                                    while ($row_kategori = mysqli_fetch_array($result)) {
                                                        if ($row_kategori[0] == $row['id_kategori_freelance']) {
                                                    ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="judul" name="judul" value="<?= $row['judul_freelance']; ?>" data-validate-length-range="6" data-validate-words="2" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $query = "UPDATE tb_freelance SET id_kategori_freelance='$kategori', nim='".$_SESSION['nim']."', judul_freelance='$judul', deskripsi='$deskripsi', file='$nameFile' where id_freelance='".$id."'";
