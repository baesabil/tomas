...
$query = "SELECT * FROM tb_denah WHERE id_denah=$id";
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="select2_single form-control col-md-7 col-xs-12" required="required" name="gambar_denah">
                                                    ...
                                                    while ($row_denah = mysqli_fetch_array($result)) {
                                                        if ($row_denah[0] == $row['id_gambar_denah']) {
                                                    ?>
                                                            <option value="<?= $row_denah[0]; ?>" selected><?= $row_denah[0] . " - " . $row_denah[2]; ?></option>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <option value="<?= $row_denah[0]; ?>"><?= $row_denah[0] . " - " . $row_denah[2]; ?></option>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="select2_single form-control col-md-7 col-xs-12" required="required" name="kategori">
                                                    ...
                                                    while ($row_kategori = mysqli_fetch_array($result)) {
                                                        if ($row_kategori[0] == $row['id_kategori_bangunan']) {
                                                    ?>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $query = "UPDATE tb_denah SET id_kategori_bangunan='$kategori', id_gambar_denah='$gambar_denah', deskripsi='$deskripsi' where id_denah='".$id."'";
