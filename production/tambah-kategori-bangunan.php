...
<head>
  ...
  <title>Tambah Kategori Bangunan</title>
        ...
        <div class="">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Tambah Kategori Bangunan</h2>
                ...
                <div class="x_content">
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $query = "INSERT INTO tb_kategori_bangunan (id_kategori_bangunan, deskripsi) VALUES (NULL, '$kategori')";
